...
| basis.binio | `BinIO`: `openIn`, `openOut`, `openAppend`, `closeIn`, `closeOut`, `output`, `inputAll`, `flushOut` | Partial | No element operations (`input1`, `inputN`, `output1`, ...) yet; shares `TextIO`'s stream types. |
