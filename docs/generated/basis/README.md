...
| Signature |  | Status | Documented |
| --- | --- | --- | --- |
| [`RUNTIME`](sig/RUNTIME.md) | What a program can ask about the machine it is running on: how much work it has done, and how much memory that took. | extension | 2 of 2 |
