...
[The Standard ML Basis Library](../README.md) &rsaquo; Sequences &rsaquo; [Structures](../structures.md) &rsaquo; **WordArraySlice**
...
| val | [`foldl`](../sig/MONO_ARRAY_SLICE.md#val-foldl) | `(word * 'a -> 'a) -> 'a -> slice -> 'a` |
| val | [`foldli`](../sig/MONO_ARRAY_SLICE.md#val-foldli) | `(int * word * 'b -> 'b) -> 'b -> slice -> 'b` |
| val | [`foldr`](../sig/MONO_ARRAY_SLICE.md#val-foldr) | `(word * 'c -> 'c) -> 'c -> slice -> 'c` |
| val | [`foldri`](../sig/MONO_ARRAY_SLICE.md#val-foldri) | `(int * word * 'd -> 'd) -> 'd -> slice -> 'd` |
