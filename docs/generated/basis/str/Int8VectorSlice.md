...
[The Standard ML Basis Library](../README.md) &rsaquo; Sequences &rsaquo; [Structures](../structures.md) &rsaquo; **Int8VectorSlice**
...
```sml
structure Int8VectorSlice :> MONO_VECTOR_SLICE where type vector = Int8Vector.vector where type elem = Int8.int
```
...
| val | [`foldl`](../sig/MONO_VECTOR_SLICE.md#val-foldl) | `(Int8.int * 'a -> 'a) -> 'a -> slice -> 'a` |
| val | [`foldli`](../sig/MONO_VECTOR_SLICE.md#val-foldli) | `(int * Int8.int * 'b -> 'b) -> 'b -> slice -> 'b` |
| val | [`foldr`](../sig/MONO_VECTOR_SLICE.md#val-foldr) | `(Int8.int * 'c -> 'c) -> 'c -> slice -> 'c` |
| val | [`foldri`](../sig/MONO_VECTOR_SLICE.md#val-foldri) | `(int * Int8.int * 'd -> 'd) -> 'd -> slice -> 'd` |
