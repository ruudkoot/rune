...
[The Standard ML Basis Library](../README.md) &rsaquo; Sequences &rsaquo; [Structures](../structures.md) &rsaquo; **WordArray2**
...
| val | [`appi`](../sig/MONO_ARRAY2.md#val-appi) | `traversal -> (int * int * word -> unit) -> {base : array, col : int, ncols : int option, nrows : int option, row : int} -> unit` |
...
| val | [`foldi`](../sig/MONO_ARRAY2.md#val-foldi) | `traversal -> (int * int * word * 'b -> 'b) -> 'b -> {base : array, col : int, ncols : int option, nrows : int option, row : int} -> 'b` |
...
| val | [`modifyi`](../sig/MONO_ARRAY2.md#val-modifyi) | `traversal -> (int * int * word -> word) -> {base : array, col : int, ncols : int option, nrows : int option, row : int} -> unit` |
