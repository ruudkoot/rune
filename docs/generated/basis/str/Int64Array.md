...
[The Standard ML Basis Library](../README.md) &rsaquo; Sequences &rsaquo; [Structures](../structures.md) &rsaquo; **Int64Array**
...
```sml
structure Int64Array :> MONO_ARRAY where type vector = Int64Vector.vector where type elem = Int64.int
```
...
| val | [`foldli`](../sig/MONO_ARRAY.md#val-foldli) | `(int * Int64.int * 'b -> 'b) -> 'b -> array -> 'b` |
| val | [`foldr`](../sig/MONO_ARRAY.md#val-foldr) | `(Int64.int * 'c -> 'c) -> 'c -> array -> 'c` |
| val | [`foldri`](../sig/MONO_ARRAY.md#val-foldri) | `(int * Int64.int * 'd -> 'd) -> 'd -> array -> 'd` |
