...
[The Standard ML Basis Library](../README.md) &rsaquo; Numbers &rsaquo; [Structures](../structures.md) &rsaquo; **PackReal32Big**
...
```sml
structure PackReal32Big : PACK_REAL where type real = Real32.real
```
