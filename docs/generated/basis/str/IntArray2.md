...
[The Standard ML Basis Library](../README.md) &rsaquo; Sequences &rsaquo; [Structures](../structures.md) &rsaquo; **IntArray2**
...
| type | [`elem`](../sig/MONO_ARRAY2.md#type-elem) | `int` |
...
| val | [`app`](../sig/MONO_ARRAY2.md#val-app) | `traversal -> (int -> unit) -> array -> unit` |
| val | [`appi`](../sig/MONO_ARRAY2.md#val-appi) | `traversal -> (int * int * int -> unit) -> {base : array, col : int, ncols : int option, nrows : int option, row : int} -> unit` |
| val | [`array`](../sig/MONO_ARRAY2.md#val-array) | `int * int * int -> array` |
...
| val | [`fold`](../sig/MONO_ARRAY2.md#val-fold) | `traversal -> (int * 'a -> 'a) -> 'a -> array -> 'a` |
| val | [`foldi`](../sig/MONO_ARRAY2.md#val-foldi) | `traversal -> (int * int * int * 'b -> 'b) -> 'b -> {base : array, col : int, ncols : int option, nrows : int option, row : int} -> 'b` |
| val | [`fromList`](../sig/MONO_ARRAY2.md#val-fromlist) | `int list list -> array` |
| val | [`modify`](../sig/MONO_ARRAY2.md#val-modify) | `traversal -> (int -> int) -> array -> unit` |
| val | [`modifyi`](../sig/MONO_ARRAY2.md#val-modifyi) | `traversal -> (int * int * int -> int) -> {base : array, col : int, ncols : int option, nrows : int option, row : int} -> unit` |
...
| val | [`sub`](../sig/MONO_ARRAY2.md#val-sub) | `array * int * int -> int` |
| val | [`tabulate`](../sig/MONO_ARRAY2.md#val-tabulate) | `traversal -> int * int * (int * int -> int) -> array` |
| val | [`update`](../sig/MONO_ARRAY2.md#val-update) | `array * int * int * int -> unit` |
