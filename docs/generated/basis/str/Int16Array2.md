# structure Int16Array2

[The Standard ML Basis Library](../README.md) &rsaquo; Sequences &rsaquo; [Structures](../structures.md) &rsaquo; **Int16Array2**
...
| type | [`elem`](../sig/MONO_ARRAY2.md#type-elem) | `Int16.int` |
...
| val | [`app`](../sig/MONO_ARRAY2.md#val-app) | `traversal -> (Int16.int -> unit) -> array -> unit` |
| val | [`appi`](../sig/MONO_ARRAY2.md#val-appi) | `traversal -> (int * int * Int16.int -> unit) -> {base : array, col : int, ncols : int option, nrows : int option, row : int} -> unit` |
| val | [`array`](../sig/MONO_ARRAY2.md#val-array) | `int * int * Int16.int -> array` |
...
| val | [`fold`](../sig/MONO_ARRAY2.md#val-fold) | `traversal -> (Int16.int * 'a -> 'a) -> 'a -> array -> 'a` |
| val | [`foldi`](../sig/MONO_ARRAY2.md#val-foldi) | `traversal -> (int * int * Int16.int * 'b -> 'b) -> 'b -> {base : array, col : int, ncols : int option, nrows : int option, row : int} -> 'b` |
| val | [`fromList`](../sig/MONO_ARRAY2.md#val-fromlist) | `Int16.int list list -> array` |
| val | [`modify`](../sig/MONO_ARRAY2.md#val-modify) | `traversal -> (Int16.int -> Int16.int) -> array -> unit` |
| val | [`modifyi`](../sig/MONO_ARRAY2.md#val-modifyi) | `traversal -> (int * int * Int16.int -> Int16.int) -> {base : array, col : int, ncols : int option, nrows : int option, row : int} -> unit` |
...
| val | [`sub`](../sig/MONO_ARRAY2.md#val-sub) | `array * int * int -> Int16.int` |
| val | [`tabulate`](../sig/MONO_ARRAY2.md#val-tabulate) | `traversal -> int * int * (int * int -> Int16.int) -> array` |
| val | [`update`](../sig/MONO_ARRAY2.md#val-update) | `array * int * int * Int16.int -> unit` |
