          ...
          | SOME c =>
            if Char.isAlpha c then
              ...
              in if List.exists (fn s => s = word) deferred
                 then Source.fail p "unsupported" ("'" ^ word ^ "' is not supported in M1")
                 else Word word end
