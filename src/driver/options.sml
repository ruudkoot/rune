...
struct
  ...
  val usage =
    ...
    \  --dump-code       print the generated bytecode (--dump-after=stack, or\n\
    \                    registers with --target=registers)\n\
  ...
  fun parse (args : string list) : unit =
    ...
    | "--dump-code" :: rest => (Pass.dumpAfter := !Pass.dumpAfter @ ["stack", "registers"]; parse rest)
