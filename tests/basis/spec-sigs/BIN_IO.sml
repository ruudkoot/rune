(* signature BIN_IO, transcribed from
   ...
   It includes SPEC_IMPERATIVE_IO of tests/basis/spec-sigs/IMPERATIVE_IO.sml,
   whose substructure has SPEC_STREAM_IO of STREAM_IO.sml; a test that uses
   this file uses those first. *)
signature SPEC_BIN_IO =
sig
  include SPEC_IMPERATIVE_IO
