(* signature WINDOWS, transcribed from https://smlfamily.github.io/Basis/windows.html

   The page declares `structure Windows :> WINDOWS`, which is OPTIONAL. Key
   includes BIT_FLAGS, as the page writes it. *)
signature SPEC_WINDOWS =
sig
  structure Key : sig
    include BIT_FLAGS
    val allAccess : flags
