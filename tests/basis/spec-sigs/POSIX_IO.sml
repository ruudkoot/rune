(* signature POSIX_IO, transcribed from
   ...
   file_desc is Posix.ProcEnv.file_desc, open_mode is Posix.FileSys.open_mode)
   are not written into the signature; posix_io_sig.sml checks them. *)
signature SPEC_POSIX_IO =
sig
  eqtype file_desc
  eqtype pid
